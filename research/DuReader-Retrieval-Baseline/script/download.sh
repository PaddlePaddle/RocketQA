...
wget --ftp-user=work --ftp-password=dqa@baidu123 https://dataset-bj.cdn.bcebos.com/qianyan/dureader-retrieval-baseline-dataset.tar.gz
...
wget --ftp-user=work --ftp-password=dqa@baidu123 https://dataset-bj.cdn.bcebos.com/qianyan/ernie_base_1.0_CN.tar.gz
wget --ftp-user=work --ftp-password=dqa@baidu123 https://dataset-bj.cdn.bcebos.com/qianyan/ernie_base_1.0_twin_CN.tar.gz
...
wget --ftp-user=work --ftp-password=dqa@baidu123 https://dataset-bj.cdn.bcebos.com/qianyan/dual_finetuned_params.tar.gz
wget --ftp-user=work --ftp-password=dqa@baidu123 https://dataset-bj.cdn.bcebos.com/qianyan/cross_finetuned_params.tar.gz
